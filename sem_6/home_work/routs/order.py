...
from sem_6.home_work.db import orders, products, users, database
from sem_6.home_work.models.models import Order, OrderIn
...
async def get_orders():
    query = (
        select(
            ...
            orders.c.date.label("order_date"),
            ...
            products.c.price.label("product_price"),
        )
        .join(products)
        .join(users)
    )
